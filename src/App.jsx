...
import bg_currency_converter  from "./assets/bg_currency_converter.jpg"
...
return (
    <div
        ...
        style={{ backgroundImage: `url(${bg_currency_converter})` }}
    >
        <div className="w-full">
            <h1 className="text-3xl font-bold text-center text-white mb-6">Currency Converter</h1>
